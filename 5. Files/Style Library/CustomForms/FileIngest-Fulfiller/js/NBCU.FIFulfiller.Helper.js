NBCU.FIFulfiller.Helper = function () {
    this.saveID = 0;
    this.txtUnit = 0;
    this.txtDevice = 0;
    this.neweditRequestData = {};
    ...
    var date = new Date();
    var FileIngestIdPrefix = "FI" + date.getFullYear();
    ...
    this.checkRemove = function (list, crewID, Field) {
        ...
        if (getData.length > 0) {
            ...
            $.each(getData, function (index, val) {
                ...
                NBCU.FIFulfiller.Helper.deleteItem(data, list, val.ID);
            })
        }
    }
    ...
    return {
        ...
        txtDevice: this.txtDevice,
        neweditRequestData: this.neweditRequestData,
